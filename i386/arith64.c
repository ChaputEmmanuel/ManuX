...
static arith64_s64 __absvdi2(arith64_s64 a)
{
    return arith64_abs(a);
}

// Return the result of shifting a left by b bits.
static arith64_s64 __ashldi3(arith64_s64 a, int b)
{
...
static arith64_s64 __ashrdi3(arith64_s64 a, int b)
{
    arith64_word w = {.s64 = a};
...
static int __clzsi2(arith64_u32 a)
{
    int b, n = 0;
...
static int __clzdi2(arith64_u64 a)
{
    int b, n = 0;
...
static int __ctzsi2(arith64_u32 a)
{
    int b, n = 0;
...
static int __ctzdi2(arith64_u64 a)
{
    int b, n = 0;
...
static arith64_u64 __divmoddi4(arith64_u64 a, arith64_u64 b, arith64_u64 *c)
{
...
static int __ffsdi2(arith64_u64 a)
{
    return a ? __ctzdi2(a) + 1 : 0;
}

// Return the result of logically shifting a right by b bits.
static arith64_u64 __lshrdi3(arith64_u64 a, int b)
{
...
static int __popcountsi2(arith64_u32 a)
{
...
// Return the number of bits set in a.
static int __popcountdi2(arith64_u64 a)
{
    // collect sums into two low bytes
...
static arith64_u64 __udivdi3(arith64_u64 a, arith64_u64 b)
{
    return __divmoddi4(a, b, (void *)0);
}

// Return the remainder of the unsigned division of a and b.
static arith64_u64 __umoddi3(arith64_u64 a, arith64_u64 b)
{
    arith64_u64 r;
    __divmoddi4(a, b, &r);
    return r;
