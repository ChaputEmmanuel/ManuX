...
de propriétés qui lui sont propre. La pagination va nécessiter la
...
dans le segment, comme l'illustre la figure \ref{figure:adresse-logique} ci-dessous. On
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.6\textwidth]{images/adresse-logique.png}
\caption{\label{figure:adresse-logique}Principe d'une adresse logique}
\end{center}
\end{figure} 
...
segment. La figure \ref{figure:adresse-logique-sel} illustre cette indirection.

\begin{figure}[htbp]
\includegraphics[width=0.4\textwidth]{images/adresse-logique-sel}
\caption{\label{figure:adresse-logique-sel}Adresse logique et sélecteur de segment}
\end{figure} 
...
%\begin{figure}[htbp]
\includegraphics[width=\textwidth]{images/etat-memoire-boot}
...
\includegraphics[width=0.5\textwidth]{images/proprietaire-page}
