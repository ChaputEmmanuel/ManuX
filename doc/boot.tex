...
\begin{itemize}
   ...
   \item Nous observerons ensuite des outils un peu plus modernes
     ...
     Dans cette situation, nous utiliserons par exemple GRUB qui fera
...
\begin{itemize}
     \item un {\em secteur de boot} sera un code de moins de 512
       octets qui va s'occuper de charger le noyau ;
