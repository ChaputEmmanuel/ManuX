...
%
%-------------------------------------------------------------------------------
\subsection{Création d'un entête}

   Le système {\em Multiboot} nécessite un entête devant le noyau avec
des caractéristiques bien définies. En ce qui concerne ManuX, il est
