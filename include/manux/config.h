/**
 * @file  include/manux/config.h
 * @brief Définition des éléments de configuration de ManuX
 *
 * Les options et
 ...
 *
 *    Des variantes de ce fichier se trouvent dans le dossier multiconf et
 * permettent de gérer diverses variantes du noyau.
 *
